...
class ControllerPaymentInstamojo extends Controller {
  ...
  protected function index() {
    ...
    $this->data['action'] = $this->config->get('instamojo_payment_link');
    ...
    if ($order_info) {
      ...
      $this->data['custom_field_name'] = $custom_field_name;
      $this->data['custom_field'] = $orderid;

      if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/instamojo.tpl')){
        $this->template = $this->config->get('config_template') . '/template/payment/instamojo.tpl';
      } else {
        $this->template = 'default/template/payment/instamojo.tpl';
      }
        $this->render();
    }
  }
